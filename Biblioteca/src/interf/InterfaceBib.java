 ...
 * @author BrunoPC
 */
public class InterfaceBib extends javax.swing.JFrame {
    ...
    private void jb_buscaAlunoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_buscaAlunoActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "RA deve estar preenchido");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceBib.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceBib().setVisible(true);
            }
        });
    }
